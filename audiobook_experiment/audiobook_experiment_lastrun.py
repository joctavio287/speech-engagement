...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\jocta\\repos\\Speech-engagement\\psych_audiobook\\audiobook_experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    instruction_text = visual.TextStim(win=win, name='instruction_text',
        text='En el siguiente experimento vas a escuchar dos audiolibros de 5 minutos cada uno. Por favor, ponete cómodo/a e intenta sostener la mirada en la cruz de fijación que aparecerá en el centro de la pantalla durante cada cuento.\n\nCuando estes listo/a apretá la barra espaciadora: vas a escuchar unos pitidos y luego comenzará el experimento.',
        font='Arial',
    ...
    audiobook_trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('AudioBookLoop_pruebas.csv'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    for thisAudiobook_trial in audiobook_trials:
        ...
        for thisTrials_bip1 in trials_bip1:
            ...
            continueRoutine = True
            # update component parameters for each repeat
            pip.setSound('../stimuli/stimuli_audiobook/bip.wav', hamming=True)
